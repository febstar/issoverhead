...
while True:
    ...
    if is_night() and is_iss_overhead():
        ...
        connection.login(user="febstarowen@gmail.com", password=password)
        connection.sendmail(from_addr="febstarowen@gmail.com", to_addrs="febechukwuonyeyili@gmail.com", msg="Subject:Look up the iss is above\n\nThe iss is above")
